...
data=csvread("state_generated2.csv");
err_record=[];
parr_record=[];
observer=0;
...
try
    ...
    data_out=p_estim;
    namer_in=join(["D:\Research_work\My_covid_research2\dataset_preprocessing\parameter_estim\input\states_",num2str(observer+offseter+1),".csv"]);
    namer_out=join(["D:\Research_work\My_covid_research2\dataset_preprocessing\parameter_estim\output\parameters_",num2str(observer+offseter+1),".csv"]);
