...
for i=0:len_data
    tmp_name="D:\Research_work\My_covid_research2\dataset_preprocessing\parameter_estim\input\states_";
    curr_stat=csvread(join([tmp_name,num2str(i),".csv"]));
    name_input=join(["input\states_",num2str(i),".csv"]);
...
for i=0:len_data
    tmp_name="D:\Research_work\My_covid_research2\dataset_preprocessing\parameter_estim\output\parameters_";
